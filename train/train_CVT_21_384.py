...
num_classes=2
batch_size = 30
file_name = '20220325_CVT_21_384_in22k_e'+str(Epoch)+'_opti_SGD_lr_100latecos_'+str(Learning_rate)+'2.000001_bat_'+str(batch_size)+'_autoaug_imgn_clip_0.5_board'
device_num = 0
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer_ft, T_0=100, T_mult=1, eta_min=0.000001)
