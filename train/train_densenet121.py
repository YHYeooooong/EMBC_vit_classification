...
import os
import copy
from ..tensorboard.Densenet_tensorboard import write_tensorboard
...
num_classes=2
batch_size = 30
file_name = '20220407_densenet121_e'+str(Epoch)+'_opti_SGD_lr'+str(Learning_rate)+'_bat_'+str(batch_size)+'_+aaug_clip_1'
device_num = 1
