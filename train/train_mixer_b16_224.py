...
from ..tensorboard.mixer_b_tensorboard import write_tensorboard
...
num_classes=2
batch_size = 30
file_name = '20220327_mixer_b16_224_in21k_e'+str(Epoch)+'_opti_SGD_lr_oneGitcos0.00012'+str(Learning_rate)+'_up10_bat_'+str(batch_size)+'_autoaug_imgn_clip0.1'
device_num = 0

device = torch.device("cuda:"+str(device_num) if torch.cuda.is_available() else "cpu")
CCpu = torch.device('cpu')

model = timm.create_model('mixer_b16_224_in21k', pretrained=True, num_classes=num_classes)
